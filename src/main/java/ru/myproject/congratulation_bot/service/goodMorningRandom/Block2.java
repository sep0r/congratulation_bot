...
public class Block2 {
    ...
    public void getBlock(ListPhrasesUtil phrase, GMTable2_3_1Repository gm2_3_1, GMTable2_3_2Repository gm2_3_2, GMTable2_3_3Repository gm2_3_3, GMTable2_3_4Repository gm2_3_4,
        ...
        switch (fork1) {
            case 0:
                phrase.tab2_3 = gm2_3_1.findById(random(gm2_3_1.getCount())).get().getText();
                int randomNum = random(gm2_4_1.getCount());
                if (fiftyFifty()) {
                ...
                break;
            case 1:
                phrase.tab2_3 = gm2_3_2.findById(random(gm2_3_2.getCount())).get().getText();
                int randomNum2 = random(gm2_4_2.getCount());
                if (fiftyFifty()) {
                ...
                break;
            case 2:
                phrase.tab2_3 = gm2_3_3.findById(random(gm2_3_3.getCount())).get().getText();
                phrase.tab2_4 = gm2_4_3.findById(random(gm2_4_3.getCount())).get().getText();
                break;
            case 3:
                phrase.tab2_3 = gm2_3_4.findById(random(gm2_3_4.getCount())).get().getText();
                int randomNum4 = random(gm2_4_4.getCount());
                if (fiftyFifty()) {
